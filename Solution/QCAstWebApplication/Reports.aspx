                        ...
                        <td colspan="3"> 
                            <table cellpadding="5" cellspacing="0">
                                <tr>
                                    ...
                                    <td>Invoices:</td>
                                    <td><asp:DropDownList ID="lstClientHistory" runat="server" width="150" 
                                            CssClass="ddlStyle" DataTextField="InvoiceDate" DataValueField="IdInvoice" 
                                            onselectedindexchanged="lstClientHistory_SelectedIndexChanged"></asp:DropDownList></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                            ...
                            <table cellpadding="5" cellspacing="0">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:TextBox ID="txtStartDate" runat="server" CssClass="textboxDate"></asp:TextBox>

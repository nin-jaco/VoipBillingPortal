            ...
            <asp:ScriptManager ID="ScriptManager1" runat="server">
                ...
                <table align="center" style="margin-left:20px; margin-top:25px">
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlClients" runat="server" CssClass="ddlStyle" AutoPostBack="True" onselectedindexchanged="ddlClients_SelectedIndexChanged" DataTextField="ClientName" DataValueField="IdClient"></asp:DropDownList>
                        </td>  
                    ...
                    <tr>
                        ...
                        <td>
                            &nbsp;</td>
                        <td colspan="2">
                            <asp:ImageButton ID="btnCreateInvoice" ImageUrl="~/Images/btnCreateInvoice.png" runat="server" onclick="btnCreateInvoice_Click" />
